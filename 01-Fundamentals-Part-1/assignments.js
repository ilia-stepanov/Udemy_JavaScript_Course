...
// 3. Confirm that 'percentages2' contains exactly the same values as the 'percentages' 
// array that we created manually in the previous assignment, 
...
// 2. Log only the neighboring countries to the console, one by one, not the entire arrays. 
...
// 2. Reflect on which solution you like better for this task: the for loop or the while loop?
